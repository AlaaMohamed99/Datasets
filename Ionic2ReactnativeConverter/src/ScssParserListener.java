...
public interface ScssParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterFromNumber(ScssParser.FromNumberContext ctx);
	/**
	 * Exit a parse tree produced by {@link ScssParser#fromNumber}.
	 * @param ctx the parse tree
	 */
	void exitFromNumber(ScssParser.FromNumberContext ctx);
	/**
	 * Enter a parse tree produced by {@link ScssParser#throughNumber}.
	 * @param ctx the parse tree
	 */
	void enterThroughNumber(ScssParser.ThroughNumberContext ctx);
	/**
	 * Exit a parse tree produced by {@link ScssParser#throughNumber}.
	 * @param ctx the parse tree
	 */
	void exitThroughNumber(ScssParser.ThroughNumberContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterVar(ScssParser.VarContext ctx);
	/**
	 * Exit a parse tree produced by {@link ScssParser#var}.
	 * @param ctx the parse tree
	 */
	void exitVar(ScssParser.VarContext ctx);
	/**
