...
public class React_Native2Typescript extends JavaScriptParserBaseListener
{
    private File file;
    private ImportStatementHandler importstatementhandler;
    private OnStartTranslationHandler onStartTranslationHandler;
    ...
    public React_Native2Typescript()
    {
        ...
        in_render=false;
        onStartTranslationHandler = new OnStartTranslationHandler();
    }
